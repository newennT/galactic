import { AdminChapterExerciseYoutubeService } from './admin-chapterExerciseYoutube.service';


describe('AdminYoutubeService', () => {
  let chapterExerciseYoutubeService: AdminChapterExerciseYoutubeService;
  const sanitizerMock = {
    bypassSecurityTrustResourceUrl: jest.fn((url) => url)
  };

  beforeEach(() => {
    chapterExerciseYoutubeService = new AdminChapterExerciseYoutubeService(sanitizerMock as any);
    jest.clearAllMocks();
  });
