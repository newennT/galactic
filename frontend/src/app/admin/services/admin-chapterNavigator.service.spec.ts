import { AdminChapterNavigatorService } from './admin-chapterNavigator.service';
import { Chapter } from '../../core/models/chapter.model';
import { Page } from '../../core/models/page.model';

describe('ChapterNavigatorService', () => {

  let service: AdminChapterNavigatorService;
  ...
  beforeEach(() => {
    service = new AdminChapterNavigatorService();
  });
