...
describe("userChapter.service", () => {
  ...
  it("should return null percentage if incomplete", () => {
    ...
    it("should build exercise view with statuses", () => {
    const exercises = [
      { id_page: 1, question: "Q1" },
      { id_page: 2, question: "Q2" },
      { id_page: 3, question: "Q3" },
    ];

    const results = [
      { id_page: 1, is_correct: true },
      { id_page: 2, is_correct: false },
    ];

    const result = service.buildExerciseView(exercises, results);
  ...
  it("should build complete chapter result", () => {
    const chapter = {
      id_chapter: 10,
      title: "Chapter",
      title_fr: "Chapitre",
    ...
    const result = service.buildChapterResult(
      chapter,
      pages,
      results
    );
