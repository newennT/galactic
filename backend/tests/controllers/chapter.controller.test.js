...
describe("ChapterController", () => {
    ...
    it("should return all chapters", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
            message: "La liste des chapitres a été récupérée",
            data: chapters,
        });
    });
    ...
    it("should return 500 if getAll fails", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
            message:
                "La liste des chapitres n'a pas pu'être récupérée. Réessayez dans quelques instants.",
            data: error,
        });
    });
    ...
    it("should delete chapter", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
            message: "Le chapitre n°1 a bien été supprimé",
            data: chapter,
        });
    });
    ...
    it("should return 404 if delete target not found", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
            message:
                "Le chapitre demandé n'a pas été trouvé. Réessayez avec un autre identifiant.",
        });
    });
    ...
    it("should return 500 if delete fails", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
            message:
                "Le chapitre n'a pas pu'être supprimé. Réessayez dans quelques instants.",
            data: error,
        });
    });
