// controllers/uniqueResponse.controller.js

const service = require("../services/uniqueResponse.service");
  ...
  try {
    ...
    if (!data) {
      return res.status(404).json({
        message: "Option réponse unique non trouvée"
      });
    }

    res.json({ message: "Trouvé", data });
  } catch (error) {
    handleError(res, error, "Erreur récupération");
  }
};
